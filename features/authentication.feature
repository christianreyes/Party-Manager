Feature: Authentication
  ...
  Scenario: Logout
	...
	Scenario: Cannot access my parties without login
		When I go to my parties page
		Then I should see "You must first log in or sign up before accessing this page"
	
	Scenario: Cannot access my guests without login
	  When I go to my guests page
	  Then I should see "You must first log in or sign up before accessing this page"
	
	Scenario: Cannot add a new party without login
	  When I go to the new party page
	  Then I should see "You must first log in or sign up before accessing this page"
	
	Scenario: Cannot add a new guest without login
