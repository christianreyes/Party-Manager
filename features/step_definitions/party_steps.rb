...
Given /^another host with parties$/ do
  ...
  @toga = Factory.create(:party, :name => "Toga Party", :host => @bluto)
  @otter = Factory.create(:guest, :party => @toga, :name => "Eric Stratton and Guests", :expected_attendees => 3, :actual_attendees => 3)
  @boon = Factory.create(:guest, :party => @toga, :name => "Schoenstein Family", :expected_attendees => 4, :actual_attendees => 4)
  @pinto = Factory.create(:guest, :party => @toga, :name => "Kroger Family", :expected_attendees => 3, :actual_attendees => 2)
end